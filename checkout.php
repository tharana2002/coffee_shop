...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($mysqli, "INSERT INTO `order`(name, number, email, method, address, total_products, total_price) VALUES('$name','$number','$email','$method','$address','$total_product','$price_total')") or die('query failed');
